...
class BodyParamsControllerTests < ControllerTestBase
  ...
  def setup
    ...
    @controller = BodyParamsController.new CONFIG, http_call_back: @response_catcher
  end
  ...
  def test_delete_plaintext_test()
    ...
    result = @controller.send_delete_plain_text(text_string)
  ...
  # Todo: Add description for test test_wrap_body_in_object1
  def test_wrap_body_in_object1()
    # Parameters for the API call
    field = ''
    name = 'farhan'
  ...
  # Todo: Add description for test test_wrap_body_in_object2
  def test_wrap_body_in_object2()
    # Parameters for the API call
    field = 'QA'
    name = ''
  ...
  # Todo: Add description for test test_wrap_body_in_object3
  def test_wrap_body_in_object3()
    # Parameters for the API call
    field = '$$'
    name = '$$'
  ...
  # Todo: Add description for test test_wrap_body_in_object4
  def test_wrap_body_in_object4()
    # Parameters for the API call
    field = 'QA&farhan'
    name = 'QA&farhan'
  ...
  # Todo: Add description for test test_additional_model_properties1
  ...
  def test_send_dynamic()
    ...
    # Perform the API call through the SDK function
    result = @controller.send_dynamic(dynamic)
  ...
  def test_send_delete_body_with_model()
    ...
    # Perform the API call through the SDK function
    result = @controller.send_delete_body_with_model(model)
  ...
  def test_send_delete_body_with_model_array()
    ...
    # Perform the API call through the SDK function
    result = @controller.send_delete_body_with_model_array(models)
  ...
  # Todo: Add description for test test_update_string_with_body1
  def test_update_string_with_body1()
    # Parameters for the API call
    value = 'TestString'
  ...
  # Todo: Add description for test test_update_special_string_with_body1
  def test_update_special_string_with_body1()
    # Parameters for the API call
    value = '$%^!@#$%^&*'
  ...
  # Todo: Add description for test test_update_multiliner_string_with_body1
  def test_update_multiliner_string_with_body1()
    # Parameters for the API call
    value = "TestString\nnouman"
  ...
  # Todo: Add description for test test_update_string_with_body_corner_case1
  def test_update_string_with_body_corner_case1()
    # Parameters for the API call
    value = ' '
  ...
  def test_update_string_array_with_body()
    ...
    # Perform the API call through the SDK function
    result = @controller.update_string_array(strings)
  ...
  # Todo: Add description for test test_send_string_with_new_line1
  def test_send_string_with_new_line1()
    # Parameters for the API call
    ...
    # Perform the API call through the SDK function
    result = @controller.send_string_with_new_line(body)
  ...
  # Todo: Add description for test test_send_string_with_new_line2
  def test_send_string_with_new_line2()
    # Parameters for the API call
    body = TestNstringEncoding.from_hash(APIHelper.json_deserialize(
  ...
  # Todo: Add description for test test_send_string_with_new_line3
  def test_send_string_with_new_line3()
    # Parameters for the API call
    body = TestNstringEncoding.from_hash(APIHelper.json_deserialize(
  ...
  # Todo: Add description for test test_send_string_with_r1
  def test_send_string_with_r1()
    # Parameters for the API call
    ...
    # Perform the API call through the SDK function
    result = @controller.send_string_with_r(body)
  ...
  # Todo: Add description for test test_send_string_with_r2
  def test_send_string_with_r2()
    # Parameters for the API call
    body = TestRstringEncoding.from_hash(APIHelper.json_deserialize(
      '{"name":"farhan","field":"QA&Dev"}'
    ))
  ...
  # Todo: Add description for test test_send_string_with_r3
  def test_send_string_with_r3()
    # Parameters for the API call
    body = TestRstringEncoding.from_hash(APIHelper.json_deserialize(
      '{"name":"farhan&nouman","field":"QA"}'
    ))
  ...
  # Todo: Add description for test test_send_string_in_body_with_r_n1
  def test_send_string_in_body_with_r_n1()
    # Parameters for the API call
    ...
    # Perform the API call through the SDK function
    result = @controller.send_string_in_body_with_r_n(body)
  ...
  # Todo: Add description for test test_send_string_in_body_with_r_n2
  def test_send_string_in_body_with_r_n2()
    # Parameters for the API call
    body = TestRNstringEncoding.from_hash(APIHelper.json_deserialize(
      '{"name":"farhan","field":"QA&Dev"}'
    ))
  ...
  # Todo: Add description for test test_send_string_in_body_with_r_n3
  def test_send_string_in_body_with_r_n3()
    # Parameters for the API call
    body = TestRNstringEncoding.from_hash(APIHelper.json_deserialize(
      '{"name":"farhan&nouman","field":"QA"}'
    ))
